...
-- CORRECTED VERSION - Mengatasi error type mismatch
...
-- 3. UPDATE DATA EXISTING (OPSIONAL) - FIXED TYPE CONVERSION
...
UPDATE public.tasks 
SET 
    school_id = '1cd40355-1b07-402d-8309-b243c098cfe9'::uuid
