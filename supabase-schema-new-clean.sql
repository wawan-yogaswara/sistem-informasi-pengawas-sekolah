...
CREATE TABLE users (
    ...
    name VARCHAR(100) NOT NULL, -- Frontend menggunakan 'name'
    role user_role DEFAULT 'user',
    nip VARCHAR(50),
    position VARCHAR(100), -- Frontend menggunakan 'position'
    photo TEXT, -- Frontend menggunakan 'photo'
...
CREATE TABLE schools (
    ...
    address TEXT,
    principal VARCHAR(100), -- Frontend menggunakan 'principal'
    phone VARCHAR(20),
    email VARCHAR(100),
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
CREATE TABLE tasks (
    ...
    title VARCHAR(200) NOT NULL, -- Frontend menggunakan 'title'
    description TEXT,
    date DATE NOT NULL, -- Frontend mengirim date sebagai DATE
...
CREATE TABLE supervisions (
    ...
    date DATE NOT NULL,
    findings TEXT, -- Frontend menggunakan 'findings'
    recommendations TEXT, -- Frontend menggunakan 'recommendations'
    photo TEXT, -- Frontend menggunakan 'photo'
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
CREATE TABLE additional_tasks (
    ...
    description TEXT,
    date DATE NOT NULL, -- Frontend mengirim date sebagai DATE
    status task_status DEFAULT 'pending', -- Frontend menggunakan 'status'
    photo TEXT, -- Frontend menggunakan 'photo'
    created_at TIMESTAMP WITH TIME ZONE DEFAULT NOW()
);
...
-- Insert sample users dengan password yang benar
